...
loop
dbms_output.put_line('delete from documents where name = '''||r.name||''';');  
dbms_output.put('insert into documents (name, mime_type, doc_size, dad_charset, last_updated, content_type, blob_content)');  
...
dbms_output.put_line('  from documents');
